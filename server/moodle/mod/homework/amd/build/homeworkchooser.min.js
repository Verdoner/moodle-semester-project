...
/**
   ...
   *
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.init=void 0,_jquery=_interopRequireDefault(_jquery),_ajax=_interopRequireDefault(_ajax),_modal_homework=_interopRequireDefault(_modal_homework),_modal_events=_interopRequireDefault(_modal_events);_exports.init=(_ref=_asyncToGenerator(_regeneratorRuntime().mark((function _callee2(cmid,title){return _regeneratorRuntime().wrap((function(_context2){for(;;)switch(_context2.prev=_context2.next){case 0:(0,_jquery.default)("#open-homework-chooser").on("click",(function(){var _done;_ajax.default.call([{methodname:"mod_homework_get_homework_chooser",args:{cmid:cmid},done:(_done=_asyncToGenerator(_regeneratorRuntime().mark((function _callee(response){var modal;return _regeneratorRuntime().wrap((function(_context){for(;;)switch(_context.prev=_context.next){case 0:return _context.next=2,_modal_homework.default.create({title:title,body:"".concat(response.html),large:!0,removeOnClose:!0});case 2:(modal=_context.sent).show(),modal.getRoot().on(_modal_events.default.shown,(function(){var startPageInput=modal.getRoot().find("#startPage")[0],endPageInput=modal.getRoot().find("#endPage")[0],radioButtons=modal.getRoot().find('input[name="option"]'),testTextarea=modal.getRoot().find("#page-range-input")[0],testLink=modal.getRoot().find("#linkDiv")[0];function validatePageRange(){var startPage=parseInt(startPageInput.value,10),endPage=parseInt(endPageInput.value,10);""!==endPageInput.value&&""!==startPageInput.value&&endPage<startPage?endPageInput.setCustomValidity("End Page must be greater than or equal to Start Page"):endPageInput.setCustomValidity("")}function toggleInputs(){document.getElementById("option1").checked?(testTextarea.style.display="block",testLink.style.display="none"):document.getElementById("option2").checked&&(testTextarea.style.display="none",testLink.style.display="block")}startPageInput.addEventListener("input",validatePageRange),endPageInput.addEventListener("input",validatePageRange),radioButtons.each((function(_,radio){radio.addEventListener("change",toggleInputs)}))})),modal.getRoot().on("click",'[data-action="submit"]',(function(e){e.preventDefault(),handleFormSubmit(modal)})),modal.getRoot().on("click",'[data-action="cancel"]',(function(e){e.preventDefault(),modal.destroy()}));case 7:case"end":return _context.stop()}}),_callee)}))),function(_x3){return _done.apply(this,arguments)}),fail:function(error){throw new Error("Failed to load homework chooser content: ".concat(error))}}])}));case 1:case"end":return _context2.stop()}}),_callee2)}))),function(_x,_x2){return _ref.apply(this,arguments)});var _ref,handleFormSubmit=function(modal){var inputField=modal.getRoot().find("#inputField").val();if(modal.getRoot().find("#option1").is(":checked")){var startPage=modal.getRoot().find("#startPage").val(),endPage=modal.getRoot().find("#endPage").val();console.log({inputfield:inputField,startpage:startPage,endpage:endPage}),_ajax.default.call([{methodname:"mod_homework_save_homework_literature",args:{inputfield:inputField,startpage:startPage,endpage:endPage},done:function(){modal.hide()},fail:function(error){throw new Error("Failed to save data: ".concat(error))}}])}else if(modal.getRoot().find("#option2").is(":checked")){var link=modal.getRoot().find("#link").val();_ajax.default.call([{methodname:"mod_homework_save_homework_link",args:{inputfield:inputField,link:link},done:function(){modal.hide()},fail:function(error){throw new Error("Failed to save data: ".concat(error))}}])}}}));
