...
/**
   ...
   *
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.init=void 0,_jquery=_interopRequireDefault(_jquery),_ajax=_interopRequireDefault(_ajax),_modals=_interopRequireDefault(_modals),_modal_events=_interopRequireDefault(_modal_events);var _ref;_exports.init=(_ref=_asyncToGenerator(_regeneratorRuntime().mark((function _callee2(homework_id,title,data){var homeworkid,buttons,i;return _regeneratorRuntime().wrap((function(_context2){for(;;)switch(_context2.prev=_context2.next){case 0:for(console.log(data),buttons=document.getElementsByClassName("timebutton"),i=0;i<buttons.length;i++)buttons[i].addEventListener("click",(function(event){homeworkid=event.target.id}));(0,_jquery.default)(document).ready((function(){(0,_jquery.default)(".timebutton").on("click",(function(){var _done;_ajax.default.call([{methodname:"block_homework_get_infohomework_modal",args:{homework_id:homeworkid},done:(_done=_asyncToGenerator(_regeneratorRuntime().mark((function _callee(response){var modal;return _regeneratorRuntime().wrap((function(_context){for(;;)switch(_context.prev=_context.next){case 0:return _context.next=2,_modals.default.create({title:title,body:"".concat(response.html),large:!0,removeOnClose:!0});case 2:return modal=_context.sent,_context.next=5,modal.show();case 5:modal.getRoot().on(_modal_events.default.shown,(function(){}));case 6:case"end":return _context.stop()}}),_callee)}))),function(_x4){return _done.apply(this,arguments)}),fail:function(error){throw new Error("Failed to load info homework content: ".concat(JSON.stringify(error)))}}])}))}));case 4:case"end":return _context2.stop()}}),_callee2)}))),function(_x,_x2,_x3){return _ref.apply(this,arguments)})}));
