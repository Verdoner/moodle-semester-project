...
REM Add PHPMyAdmin service if available
SET PHPADMINFILE=%BASEDIR%\service.phpmyadmin.yml
IF EXIST %PHPADMINFILE% (
    SET DOCKERCOMPOSE=%DOCKERCOMPOSE% -f "%PHPADMINFILE%"
)
